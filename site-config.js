const MAC_ARM64_DOWNLOAD_URL = "https://github.com/anyao3/anyao-multi-video-player-site/releases/download/v0.3.4/Anyao.Multi.Video.Player-0.3.4-arm64.dmg";
const MAC_X64_DOWNLOAD_URL = "https://github.com/anyao3/anyao-multi-video-player-site/releases/download/v0.3.4/Anyao.Multi.Video.Player-0.3.4-x64.dmg";
const WINDOWS_DOWNLOAD_URL = "https://github.com/anyao3/anyao-multi-video-player-site/releases/download/v0.3.4/Anyao.Multi.Video.Player.Setup.0.3.4.exe";
